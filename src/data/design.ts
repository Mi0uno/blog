...
export const DESIGN_DATA: Project[] = [
  ...
  },
  {
    ...
    zh: {
      ...
      concept: "起初我想采取扁平化的设计，但信息可视化如果都是扁平化，视觉表现跟数据便会风格重复，从而观众视觉疲劳。于是最后我采取了2.5D加描边的方案，给作品增加了深度。使用低饱和互补色，红色作为强调色。",
      awards: ['中南赛区三等奖'],
    },
    en: {
      ...
      concept: "Initially, I considered a flat design, but if data viz is too flat, it conflicts with the data itself visually. To avoid visual fatigue, I adopted a 2.5D plus outline scheme to add depth, using low-saturation complementary colors with red as an accent.",
